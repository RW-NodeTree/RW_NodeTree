    ...
    internal static partial class StatWorker_Patcher
    {
        ...
        private static bool PreStatWorker_GearHasCompsThatAffectStat(Thing gear, StatDef stat, ref Dictionary<string, object?> __state)
        {
            ...
            if (comp != null)
            {
                ...
                return comp.PreStatWorker_GearHasCompsThatAffectStat(stat, __state);
            }
            return true;
        }
        ...
        private static bool PreStatWorker_StatOffsetFromGear(Thing gear, StatDef stat, ref Dictionary<string, object?> __state)
        {
            ...
            {
                __state = new Dictionary<string, object?>();
                return comp.PreStatWorker_StatOffsetFromGear(stat, __state);
            }
            return true;
        }
        ...
        private static bool PreStatWorker_InfoTextLineFromGear(Thing gear, StatDef stat, ref Dictionary<string, object?> __state)
        {
            ...
            {
                __state = new Dictionary<string, object?>();
                return comp.PreStatWorker_InfoTextLineFromGear(stat, __state);
            }
            return true;
        }
        ...
        private static void PostStatWorker_GearHasCompsThatAffectStat(Thing gear, StatDef stat, ref bool __result, Dictionary<string, object?> __state)
        {
            ...
            __result = processer?.PostStatWorker_GearHasCompsThatAffectStat(stat, __result, __state) ?? __result;
        }
        ...
        {
            IStatGearAffectPatcher? processer = gear as IStatGearAffectPatcher;
            __result = processer?.PostStatWorker_StatOffsetFromGear(stat, __result, __state) ?? __result;
        }
        ...
        {
            IStatGearAffectPatcher? processer = gear as IStatGearAffectPatcher;
            __result = processer?.PostStatWorker_InfoTextLineFromGear(stat, __result, __state) ?? __result;
        }
        ...
        {
            IStatGearAffectPatcher? processer = gear as IStatGearAffectPatcher;
            __result = processer?.FinalStatWorker_GearHasCompsThatAffectStat(stat, __result, __state, __exception) ?? __result;
        }
        ...
        {
            IStatGearAffectPatcher? processer = gear as IStatGearAffectPatcher;
            __result = processer?.FinalStatWorker_StatOffsetFromGear(stat, __result, __state, __exception) ?? __result;
        }
        ...
        {
            IStatGearAffectPatcher? processer = gear as IStatGearAffectPatcher;
            __result = processer?.FinalStatWorker_InfoTextLineFromGear(stat, __result, __state, __exception) ?? __result;
        }
    }
    
    public partial interface IStatGearAffectPatcher
    {
        bool PreStatWorker_GearHasCompsThatAffectStat(StatDef stat, Dictionary<string, object?> stats);
        bool PreStatWorker_StatOffsetFromGear(StatDef stat, Dictionary<string, object?> stats);
        bool PreStatWorker_InfoTextLineFromGear(StatDef stat, Dictionary<string, object?> stats);
        bool PostStatWorker_GearHasCompsThatAffectStat(StatDef stat, bool result, Dictionary<string, object?> stats);
        float PostStatWorker_StatOffsetFromGear(StatDef stat, float result, Dictionary<string, object?> stats);
        string PostStatWorker_InfoTextLineFromGear(StatDef stat, string result, Dictionary<string, object?> stats);
        IEnumerable<Thing> PostStatWorker_RelevantGear(Pawn pwan, StatDef stat, IEnumerable<Thing> result);
        bool FinalStatWorker_GearHasCompsThatAffectStat(StatDef stat, bool result, Dictionary<string, object?> stats, Exception exception);
        float FinalStatWorker_StatOffsetFromGear(StatDef stat, float result, Dictionary<string, object?> stats, Exception exception);
        string FinalStatWorker_InfoTextLineFromGear(StatDef stat, string result, Dictionary<string, object?> stats, Exception exception);
    }
}